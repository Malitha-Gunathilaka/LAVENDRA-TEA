export const teaTypes = [
  ...
  //   flavors: ["Ginger"],
  //   description:
  //     "Caffeine-free alternatives with all the taste and aroma of regular tea leaves but without the caffeine. Our decaf tea is perfect for those who want to enjoy a cup of tea without the caffeine jitters. Our decaf tea is climate-positive certified and are withered and steamed to preserve its fresh natural flavour. ",
  //   price: "$7.99",
  ...
  //   description:
  //     "Harvested at precise times from the Bogawantalawa golden valley, Legend Green Tea contains a full body liquor along with robust flavour. Legend Green Tea is produced with over a century of expertise and know-how that’s been passed down through generations. Our Green Tea is climate-positive certified and are withered and steamed to preserve its fresh natural flavour.",
  //   price: "$8.99",
